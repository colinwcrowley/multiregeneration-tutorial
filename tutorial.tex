...
parabola, which is the other irreducible component. [ADD DEFINITION OF 
DIMENSION?] Which two points of the parabola were chosen, and why? To 
answer this question, we introduce some language from numerical 
algebraic geometry.
